...
object Lugares {
    ...
    init {
        ...
        val lugar1 = Lugar("Lucerna", "Deliciosos platillos para disfrutar en familia", 1, EstadoLugar.ACEPTADO, 3, "Cl. 20 #14-41",73.3434f, -40.4345f, 1)
        lugar1.id = 1
        lugar1.horarios.add(horario2)

        val lugar2 = Lugar("Bar Zonica", "Bar en la ciudad de Armenia", 2, EstadoLugar.ACEPTADO, 5, "Cra. 14 # 22-41",73.3434f, -40.4345f, 1)
        lugar2.id = 2
        lugar2.telefonos = tels
        lugar2.horarios.add(horario1)

        val lugar3 = Lugar("Café Quindío", "Café delicioso y exclusivo", 3, EstadoLugar.ACEPTADO, 2, "Cra 20 #32-29",73.3434f, -40.4345f, 5)
        lugar3.id = 3
        ...
        val lugar5 = Lugar("Hotel Montes de la Castellana", "Hotel de tres estrellas", 1, EstadoLugar.ACEPTADO, 1, "Cl. 14 Nte. #10-34",73.3434f, -40.4345f, 1)
        lugar5.id = 5
        lugar5.horarios.add( horario1 )

        val lugar6 = Lugar("Ayenda Calypso 1142", "Ideal para visitantes", 2, EstadoLugar.SIN_REVISAR, 1, "Cra. 24 Bis #72-08",73.3434f, -40.4345f, 2)
        lugar6.id = 6
    ...
    fun listarPorPropietario(codigo:Int):ArrayList<Lugar>{
        return lugares.filter { l -> l.idCreador == codigo }.toCollection(ArrayList())
    }
