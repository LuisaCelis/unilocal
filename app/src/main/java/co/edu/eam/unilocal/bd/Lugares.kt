...
import co.edu.eam.unilocal.model.Posicion
...
object Lugares {
    ...
    init {
        ...
        //val lugar1 = Lugar("Lucerna", "Deliciosos platillos para disfrutar en familia", 1, EstadoLugar.SIN_REVISAR, 3, "Cl. 20 #14-41", Posicion(4.5331905,-75.6732479), 1 )
        //lugar1.id = 3
        ...
        /*val lugar3 = Lugar("Café Quindío", "Café delicioso y exclusivo", 3, EstadoLugar.RECHAZADO, 2, "Cra 20 #32-29",Posicion(4.5331905,-75.6732479),  5)
        lugar3.id = 4
        lugar3.horarios.add(horario1)

        val lugar4 = Lugar("Luchos Bar", "Los mejores cocteles de la ciudad", 1, EstadoLugar.ACEPTADO, 5, "Cra. 109a #6511",Posicion(4.5331905,-75.6732479),  3)
        lugar4.id = 5
        lugar4.horarios.add(horario3)

        val lugar5 = Lugar("Hotel Montes de la Castellana", "Hotel de tres estrellas", 1, EstadoLugar.SIN_REVISAR, 1, "Cl. 14 Nte. #10-34",Posicion(4.5331905,-75.6732479),  1)
        lugar5.id = 6
        lugar5.horarios.add( horario1 )

        val lugar6 = Lugar("Ayenda Calypso 1142", "Ideal para visitantes", 2, EstadoLugar.ACEPTADO, 1, "Cra. 24 Bis #72-08",Posicion(4.5331905,-75.6732479),  2)
        lugar6.id = 7
    ...
    fun obtener(id:String?): Lugar?{
        return lugares.firstOrNull { l -> l.key == id }
    }
